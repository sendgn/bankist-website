...
const headerObserver = new IntersectionObserver(stickNav, {
  root: null,
  threshold: 0,
  rootMargin: `-${navHeight}px`, // number of pixels 'before' the treshold will be reached (height of the navbar)
});
...
const loadImg = function (entries, observer) {
  ...
  // remove blur effect only when img with high resolution is loaded
  // otherwise it will be removed when replacement hasn't done yet
...
// NOTE: We can also pass into the function an option parameter as an object
...
const slider = function () {
  ...
  let currentSlide = 0;
  // -1 because slides are zero-based
